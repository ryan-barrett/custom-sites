...
import './FullFeature.css';

class FullFeature extends Component {
  constructor(props) {
    super(props);
  }
  render() {
    ...
    if (emptyComponent) {
      return (
        <div
          className="full-feature full-feature-list-view component-list-view"
          onClick={() => {
            assignComponent('fullFeature');
          }}
        >
          <h3>A Title Here</h3>
          <img
          ...
          />
          <div className="full-feature-text-content">
            All the content goes hereAll the content goes hereAll the content
            goes hereAll the content goes hereAll the content goes here All the
            content goes hereAll the content goes hereAll the content goes
            hereAll the content goes hereAll the content goes hereAll the
            content goes hereAll the content goes hereAll the content goes
            hereAll the content goes hereAll the content goes hereAll the
            content goes hereAll the content goes hereAll the content goes
            hereAll the content goes hereAll the content goes here
          </div>
        </div>
      );
    } else {
